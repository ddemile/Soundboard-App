    ...
    <>
      ...
      {cookies.user ?
        <div className="w-full bg-neutral-200 dark:bg-[#141414] max-w-3xl flex rounded-md p-4 items-center gap-3">
          <img className="rounded-full w-40 border-4 border-zinc-300 dark:border-zinc-800" src={`https://cdn.discordapp.com/avatars/${cookies.user.id}/${cookies.user.avatar}.png?size=512`} />
