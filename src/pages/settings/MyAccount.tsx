...
export default function MyAccount() {
  ...
  return (
    <>
      ...
      {cookies.user ?
        <div className="w-full bg-[#141414] max-w-3xl flex rounded-md p-2 items-center gap-3">
          <img className="rounded-full w-40" src={`https://cdn.discordapp.com/avatars/${cookies.user.id}/${cookies.user.avatar}.png?size=512`} />
