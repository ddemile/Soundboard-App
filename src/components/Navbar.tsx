    ...
    return (
        <nav className="bg-white border-gray-200 dark:bg-[#181818] border-b dark:border-stone-800 sticky">
            <div className="flex flex-wrap items-center justify-between p-4">
                ...
                <button onClick={() => open()} type="button" className="inline-flex items-center p-0 w-8 h-8 justify-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                    <span className="sr-only">Open main menu</span>
